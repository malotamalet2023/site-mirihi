            ...
            <div className="text-center">
              <div className="animate-fade-in">
                <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                  Bienvenue chez{' '}
                  <span className="text-mirihi-lime-1 drop-shadow-lg">Mirihi</span>
                </h1>
                <p className="text-xl md:text-2xl mb-6 text-blue-100 max-w-3xl mx-auto leading-relaxed">
                  Votre partenaire en diagnostic et amélioration des processus d&apos;achat
                </p>
                <p className="text-lg mb-8 text-blue-200 max-w-4xl mx-auto leading-relaxed">
                  Découvrez vos besoins spécifiques avec notre diagnostic d&apos;orientation intelligent
                  qui évalue 12 domaines clés des achats modernes : stratégie, digitalisation, achats responsables et plus.
                </p>
                <button
                  onClick={() => window.location.href = '/fr/orientation-diagnostic'}
                ...
                >
                  ...
                  Commencer le diagnostic d&apos;orientation
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-100 backdrop-blur-sm">
            <div className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-mirihi-text-dark-blue mb-6">
                Nos Modules de Diagnostic
              </h2>
              <p className="text-xl text-mirihi-text-grey mb-8 max-w-4xl mx-auto leading-relaxed">
                Diagnostics spécialisés basés sur les modèles Excel de référence pour une analyse précise de vos processus d&apos;achat
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              <div className="group bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 border border-blue-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold text-blue-900 mb-2">Orientation Stratégique</h3>
                <p className="text-blue-700 text-sm">8-10 min • Vision et alignement</p>
              </div>
              ...
              <div className="group bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold text-green-900 mb-2">Segmentation Kraljic</h3>
                <p className="text-green-700 text-sm">12-15 min • Matrice catégories</p>
              </div>
              ...
              <div className="group bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border border-purple-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold text-purple-900 mb-2">Gestion Fournisseurs</h3>
                <p className="text-purple-700 text-sm">10-12 min • SRM & clustering</p>
              </div>
              ...
              <div className="group bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-6 border border-orange-200 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                ...
                <h3 className="text-lg font-bold text-orange-900 mb-2">Maturité MMCM</h3>
                <p className="text-orange-700 text-sm">15-20 min • Évaluation globale</p>
              </div>
            </div>

            <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 mb-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">🎯 Diagnostic d&apos;Orientation Intelligent</h3>
              <div className="grid md:grid-cols-3 gap-6 mb-6">
                <div className="flex items-start space-x-4">
                  ...
                  <span className="text-gray-700 font-medium">Diagnostic adaptatif de 5 minutes avec questions dynamiques</span>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <span className="text-gray-700 font-medium">Analyse IA Gemini avec scores et graphiques radar</span>
                </div>
                <div className="flex items-start space-x-4">
                  ...
                  <span className="text-gray-700 font-medium">Recommandations personnalisées et plan d&apos;action</span>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-mirihi-text-grey max-w-3xl mx-auto">
              Des solutions complètes pour transformer votre fonction achats
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="group bg-white rounded-2xl shadow-xl hover:shadow-2xl p-8 border border-gray-100 transition-all duration-300 transform hover:-translate-y-2">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-mirihi-text-dark-blue">Nos Ressources</h3>
              </div>
              <p className="text-mirihi-text-grey mb-6 text-lg leading-relaxed">
                Explorez nos outils de diagnostic spécialisés et nos modules de formation 
                pour développer votre expertise achats.
              </p>
              <Link 
                href="/resources" 
            ...
            <div className="group bg-white rounded-2xl shadow-xl hover:shadow-2xl p-8 border border-gray-100 transition-all duration-300 transform hover:-translate-y-2">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-mirihi-text-dark-blue">Mon Compte</h3>
              </div>
              <p className="text-mirihi-text-grey mb-6 text-lg leading-relaxed">
                Accédez à vos diagnostics personnalisés, suivez votre progression 
                et consultez vos recommandations.
              </p>
              <Link 
                href="/account" 
